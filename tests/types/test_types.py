...
def test_custom_class(custom_type):
    ...
    test_input = Path(__file__).parents[1] / custom_type.parent / f"input_{custom_type.stem}.yml"
    ...
    test_cwl_file = Path(__file__).parents[1] / custom_type.parent / f"test_{custom_type.stem}.cwl"
